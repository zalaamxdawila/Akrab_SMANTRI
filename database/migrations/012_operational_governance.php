...
return [
    'version' => '012_operational_governance',
    'description' => 'Add reversible governance metadata to operational records',
    'up' => function (PDO $pdo): void {
        ...
        foreach ($tables as $table) {
            ...
            if (!$index) {
                $pdo->exec(
                    "ALTER TABLE {$table} ADD KEY {$indexName} (archived_at, id)"
                );
            }
